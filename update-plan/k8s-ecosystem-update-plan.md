...
### Helm
| 文件涵蓋版本 | 官方最新版 (3.x 系列) | 最新 4.x 版 |
|-------------|---------------------|------------|
| Helm 3.8 | **v3.21.0** (仍維護中) | **v4.2.0** |

Helm 目前雙線發展：3.x 仍在積極維護（最新 v3.21.0），同時有 v4.2.0。
- 若文件更新至 3.21.0：功能增量，無需重寫
- 若直接升級至 v4.0+：需全面更新（chart 結構、OCI 預設、API 變更）
